package com.gypsyengineer.tlsbunny.vendor.test.tls13.old.openssl;
...
public class OpensslHttpsClient extends SingleConnectionClient {

    public static void main(String[] args) throws Exception {
        try (Output output = Output.standard();
             Client client = new OpensslHttpsClient()) {
