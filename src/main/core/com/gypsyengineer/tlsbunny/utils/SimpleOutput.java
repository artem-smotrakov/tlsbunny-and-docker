...
public class SimpleOutput implements Output {
    ...
    public static void printOnlyAchtung(boolean onlyAchtung) {
        synchronized (SimpleOutput.class) {
            SimpleOutput.onlyAchtung = onlyAchtung;
        }
    }

    public static boolean printOnlyAchtung() {
        synchronized (SimpleOutput.class) {
            return SimpleOutput.onlyAchtung;
        }
    }
    ...
    public SimpleOutput(String prefix, String label) {
    ...
    @Override
    synchronized public void add(SimpleOutput output) {
